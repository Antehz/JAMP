...
public class TaskRunnerRandom {
    ...
    public static void main(String[] args) {
        ...
        AtomicInteger tablesNumber = new AtomicInteger(new Random().nextInt(maxTables) + 1);
        int threadsNumber = new Random().nextInt(maxThreads) + 1;
            ...
            new Thread(() -> {
                ...
                try (
                    ...
                    while (tableNumber > 0) {
                        ...
                        int numberColumns = new Random().nextInt(maxColumns) + 1;
                        ...
                        int rowsNumber = new Random().nextInt(maxRows) + 1;
